...
//cek session
    if (empty($_SESSION['admin'])) {
        ...
        if ($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 3 AND $_SESSION['admin'] != 2 AND $_SESSION['admin'] != 4 AND $_SESSION['admin'] != 5 AND $_SESSION['admin'] != 6 AND $_SESSION['admin'] != 7 AND $_SESSION['admin'] != 8 AND $_SESSION['admin'] != 9 AND $_SESSION['admin'] != 10 AND $_SESSION['admin'] != 12 AND $_SESSION['admin'] != 13 AND $_SESSION['admin'] != 14 AND $_SESSION['admin'] != 15 AND $_SESSION['admin'] != 18) {
            ...
            if (isset($_REQUEST['act'])) {
                ...
                switch ($act) {
                    case 'add':
                        include "tambah_ppi.php";
                        break;
                    case 'edit':
                        include "edit_ppi.php";
                        break;
                    case 'del':
                        include "hapus_ppi.php";
                        break;
                    case 'app_ppi':
                    ...
                    <div class="z-depth-1">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper blue darken-2">
                                <div class="col m7">
                                    <ul class="left">
                                        <li class="waves-effect waves-light hide-on-small-only"><a href="?page=ppi&act=add" class="judul"><i class="material-icons">mail</i>Permintaan Pekerjaan Internal</a></li>
                                        <li class="waves-effect waves-light">
                                            <a href="?page=ppi&act=add"><i class="material-icons md-24">add_circle</i> Tambah Data</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col s4 show-on-medium-and-up">
                                    <form method="post" action="?page=ppi">
            ...
            <div class="row jarak-form">
                ...
                if (isset($_REQUEST['submit'])) {
                    ...
                    echo '
                        <div class="col s12" style="margin-top: -18px;">
                            <div class="card blue lighten-5">
                                ...
                                <p class="description">Hasil pencarian untuk kata kunci <strong>"' . stripslashes($cari) . '"</strong><span class="right"><a href="?page=ppi"><i class="material-icons md-36" style="color: #333;">clear</i></a></span></p>
                                </div>
                            </div>
                        </div>
                    ...
                    $query = mysqli_query($config, "SELECT a.*, 
                                                           b.manager,waktu_ttd_ppi,catatan_ppi,
                                                           c.nama
                                                           ...
                                                           WHERE no_ppi LIKE '%$cari%' or 
                                                                 ...
                                                                 lokasi LIKE '%$cari%' ORDER by id_ppi ");
                    if (mysqli_num_rows($query) > 0) {
                        ...
                        while ($row = mysqli_fetch_array($query)) {
                            ...
                            if ($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] != 1) {
                                ...
                                echo '<a class="btn small blue waves-effect waves-light" href="?page=edit_ppi&id_ppi=' . $row['id_ppi'] . '">
                    ...
                    if (mysqli_num_rows($query) > 0) {
                        ...
                        while ($row = mysqli_fetch_array($query)) {
                            ...
                            if ($_SESSION['admin'] == 1) {
                                if ($_SESSION['admin'] == 1) {
                                    echo '
                                           <a class="btn small yellow darken-2 waves-effect waves-light tooltipped" data-position="left" data-tooltip="Lihat E-PPI" href="?page=ctk_ppi&id_ppi=' . $row['id_ppi'] . '" target="_blank">
                                                <i class="material-icons">print</i> PRINT';
                                }
                            }
                            if ($_SESSION['admin'] == 4) {
                                if (is_null($row['id_ppi'])) {
                                    echo '<a class="btn small red waves-effect waves-light tooltipped" data-position="left" data-tooltip="E-PPI Kosong" href="?page=ctk_ppi&id_ppi=' . $row['id_ppi'] . '">
                                                <i class="material-icons">assignment_turned_in</i>Kosong</a>';
                                } else {
                                    echo '<a class="btn small purple waves-effect waves-light tooltipped" data-position="left" data-tooltip="Approval E-PPI" href="?page=app_ppi&id_ppi=' . $row['id_ppi'] . '">
                                                <i class="material-icons">assignment_ind</i>Approval</a>
                                          <a class="btn small green waves-effect waves-light tooltipped" data-position="left" data-tooltip="Lihat E-PPI" href="?page=ctk_ppi&id_ppi=' . $row['id_ppi'] . '" target="_blank">
                                                <i class="material-icons">assignment_turned_in</i>Lihat E-PPI</a>';
                                }
                            }
                            if ($_SESSION['admin'] == 3) {
                                if ($_SESSION['admin'] == 3) {
                                    echo '
                                          <a class="btn small blue darken-1  waves-effect waves-light tooltipped" data-position="left" data-tooltip="Edit PPI" href="?page=ppi&act=edit&id_ppi=' . $row['id_ppi'] . '">
                                                <i class="material-icons">edit</i> EDIT</a>
                                          <a class="btn small yellow darken-3 waves-effect waves-light tooltipped" data-position="left" data-tooltip="Print PPI" href="?page=ctk_ppi&id_ppi=' . $row['id_ppi'] . '" target="_blank">
                                                <i class="material-icons">print</i> PRINT</a>';
                                }
                            }
                            if ($_SESSION['admin'] == 2 || $_SESSION['admin'] == 5) {
                                if ($_SESSION['admin']) {
                                    echo ' <a class="btn small yellow darken-3 waves-effect waves-light tooltipped" data-position="left" data-tooltip="Print PPI" href="?page=ctk_ppi&id_ppi=' . $row['id_ppi'] . '" target="_blank">
                                                <i class="material-icons">print</i> PRINT</a>';
                                }
                            }
                            if ($_SESSION['admin'] == 6 || $_SESSION['admin'] == 13 || $_SESSION['admin'] == 14 || $_SESSION['admin'] == 15 | $_SESSION['admin'] == 18) {
                                if ($_SESSION['admin']) {
                                    echo ' 
                                        <a class="btn small blue darken-1  waves-effect waves-light tooltipped" data-position="left" data-tooltip="Edit PPI" href="?page=ppi&act=edit&id_ppi=' . $row['id_ppi'] . '">
                                                <i class="material-icons">edit</i> EDIT</a>
                            ...
                            if ($_SESSION['admin'] == 7 || $_SESSION['admin'] == 8 || $_SESSION['admin'] == 9 || $_SESSION['admin'] == 10 || $_SESSION['admin'] == 12) {
                                if ($_SESSION['admin']) {
                                    echo ' 
                                        <a class="btn small yellow darken-3 waves-effect waves-light tooltipped" data-position="left" data-tooltip="Print PPI" href="?page=ctk_ppi&id_ppi=' . $row['id_ppi'] . '" target="_blank">
                                                <i class="material-icons">print</i> PRINT</a>';
                        ...
                        echo '<tr><td colspan="5"><center><p class="add">Tidak ada data untuk ditampilkan. <u><a href="?page=ppi&act=add">Tambah data baru</a></u></p></center></td></tr>';
                    }
                    echo '</tbody></table>
                        </div>
                    </div>
                    ...
                    if ($cdata > $limit) {
                        ...
                        if ($pg > 1) {
                            $prev = $pg - 1;
                            echo '<li><a href="?page=ppi&pg=1"><i class="material-icons md-48">first_page</i></a></li>
                                  <li><a href="?page=ppi&pg=' . $prev . '"><i class="material-icons md-48">chevron_left</i></a></li>';
                        } else {
                        ...
                        for ($i = 1; $i <= $cpg; $i++) {
                            if ((($i >= $pg - 3) && ($i <= $pg + 3)) || ($i == 1) || ($i == $cpg)) {
                                if ($i == $pg)
                                    echo '<li class="active waves-effect waves-dark"><a href="?page=ppi&pg=' . $i . '"> ' . $i . ' </a></li>';
                                else
                                    echo '<li class="waves-effect waves-dark"><a href="?page=ppi&pg=' . $i . '"> ' . $i . ' </a></li>';
                            }
                        }
