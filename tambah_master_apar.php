    ...
    if (isset($_REQUEST['submit'])) {
        if (empty($_REQUEST['posisi']) || empty($_REQUEST['jenis_apar']) || empty($_REQUEST['berat'])) {
            ...
            if (!is_numeric($berat) || $berat < 0) {
                ...
                header("Location: tambah_master_apar.php");
                exit();
            }
            $query = mysqli_query($config, "INSERT INTO utility_apar (posisi,jenis_apar,berat)
                VALUES ('$posisi', '$jenis_apar', '$berat')");
...
?>
            ...
            <div class="z-depth-1">
                <nav class="secondary-nav">
                    <div class="nav-wrapper blue darken-2">
                        <div class="col m7">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons md-3">add_alert</i> Tambah Master APAR</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
    ...
    <div class="row jarak-form">
        ...
        <!-- Form START -->
        <form class="col s12" method="post" action="?page=master_apar&act=add" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="input-field col s12">
                    ...
                    <input id="posisi" type="text" name="posisi" class="validate" required>
                    <?php
                ...
                <div class="input-field col s12">
                    ...
                    <input id="jenis_apar" type="text" name="jenis_apar" class="validate" required>
                    <?php
                ...
                <div class="input-field col s12">
                    ...
                    <input id="berat" type="number" name="berat" class="validate" required step="0.01">
                    <?php
