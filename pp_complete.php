            ...
            <div class="row">
                                ...
                                <div class="col m7">
                                    <ul class="left">
                                        ...
                                        <ul id='cuti_dashboard' class='dropdown-content'>
                                         ...
                                         <li class="waves-effect waves-light">
                                            <a href=""><i class="material-icons md-24">done</i> COMPLETE</a>
                                        </li>
                                    </ul>
             ...
             <div class="z-depth-1">
                <nav class="secondary-nav yellow darken-3">
                    <form method="post" action="?page=pp_complete">
            ...
            <div class="row jarak-form">
                ...
                if (isset($_REQUEST['submit'])) {
                    ...
                    $query = mysqli_query($config, "SELECT a.*,
                                                           ...
                                                           WHERE id_kabag_pp and id_kabag_keu and id_pembelian and id_gm_terbit and id_pp_gudang_terbit is not null
