                ...
                <form class="col s12" method="post" action="?page=pro_karyawan&sub=pass">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            <input id="no_hp" type="tel" class="validate" name="no_hp" value="<?php echo $_SESSION['no_hp']; ?>">
                            <?php
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="tmpt_lahir" type="text" class="validate" name="tmpt_lahir" value="<?php echo $_SESSION['tmpt_lahir']; ?>">
                            <?php
                    ...
                    <div class="row">
                        ...
                        <div class="col 6">
                            <a href="?page=pro_karyawan" class="btn small deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                        </div>
                    </div>
        ...
        <div class="row jarak-form">
            ...
            <form class="col s12" method="post" action="save.php">
                ...
                <div class="row">
                    <div class="col s3 m3">
                        <h4 class="header"></h4>
                        <div class="horizontal pro">

                            <?php
                            if (!empty($_SESSION['file'])) {
                                ?>
                                <a href="/./upload/user/<?= $_SESSION['file'] ?>"><img class="circle" src="/./upload/user/<?= $_SESSION['file'] ?>"></a>
                                <?php
                            } else {
                                ?>
                                <a href="/./asset/gif/profile.gif"><img class="circle" src="/./asset/gif/profile.gif"></a>
                            <?php }
                            ?>
                        </div>
                    </div>
                    ...
                    if ($_SESSION['admin'] == 2|$_SESSION['admin'] == 3|$_SESSION['admin'] == 4|$_SESSION['admin'] == 5|$_SESSION['admin'] == 6|$_SESSION['admin'] == 7|$_SESSION['admin'] == 8|$_SESSION['admin'] == 9|$_SESSION['admin'] == 10|$_SESSION['admin'] == 11|$_SESSION['admin'] == 12|$_SESSION['admin'] == 13|$_SESSION['admin'] == 14|$_SESSION['admin'] == 15|$_SESSION['admin'] == 16|$_SESSION['admin'] == 17|$_SESSION['admin'] == 18|$_SESSION['admin'] == 20) {
                        if ($_SESSION['admin']) {
                            ?>
                            <div class="input-field col s6">
                                <i class="material-icons prefix md-prefix">account_circle</i>
                            ...
                            <div class="input-field col s6">
                                <i class="material-icons prefix md-prefix">date_range</i>
                                <input id="kontrak_habis" type="text" value="<?= ($_SESSION['kontrak_habis'] != "0000-00-00") ? indoDate($_SESSION['kontrak_habis']) : "-"; ?>" readonly disable>
                ...
                <div class="row">
                    <div class="col m12">
                        <a href="?page=pro_karyawan&sub=pass" class="btn small blue waves-effect waves-light">EDIT PROFIL<i class="material-icons">mode_edit</i></a>
                    </div>
                </div>
