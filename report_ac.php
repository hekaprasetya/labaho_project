...
?>
    ...
    <?php
    $judul = 'Air Conditioner';
    $table = 'utility_ac'; // nama table
    $pg_name = 'ac'; // nama halaman
    $id = 'id_ac'; //id table
    $tgl = 'tgl_ac'; // tanggal (timestamp)
    // untuk isi tabel <tbody></tbody>
    $isi_row1 = array("no_form", "nama", "cuci_unit", "kondisi_outdoor", "arus_ac", "lain");
    $isi_row2 = array("tgl_ac", "nama_ac", "kondisi_kompressor", "kondisi_indoor", "isi_freon");
    // untuk judul tabel <thead></thead>
    $header1 = array("no.Form", "Pemeriksa", "cuci_unit", "kondisi_outdoor", "arus_ac", "lain");
