...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if ($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == "") {
            header("Location: ./admin.php?page=report_facility");
            die();
        } else {

            $query = mysqli_query($config, "SELECT * FROM tbl_facility WHERE tgl_wo_fc BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=facility" class="judul"><i class="material-icons">print</i> Cetak WO Facility<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
            ...
            echo '<img class="logodisp" src="./upload/' . $logo . '"/>';
             echo '<span></span><br/>';
            echo '<span><h6>LAPORAN WO Facility</h6></span><br/>';
                        ...
                        <table class="bordered" id="tbl" width="100%">
                            <thead class="blue lighten-1">
                                <tr>
                                        ...
                                        <th width="18%">Penyebab<br/><hr/>Tindakan</th>
                                         <th width="18%">Pelaksana<br/><hr/>Divisi</th>
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    echo '
                                 <tr>
                                        ...
                                        <td>' . $row['jenis_pekerjaan_fc'] . '<br/><hr>' . $row['file'] . '</td>
                                        <td>' . $row['lokasi_fc'] . '<br/><hr>' . $row['perusahaan_fc'] . '</td>
                                        <td>' . $row['penyebab_fc'] . '<br/><hr>' . $row['tindakan_fc'] . '</td>
                                        <td>' . $row['pelaksana_fc'] . '<br/><hr>' . $row['divisi_fc'] . '</td>
                                       <td><strong>' . $row['status_fc'] . '<br/><hr>' . indoDate($row['tgl_selesai_fc']) . '</strong></td>
                                        <td>';
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col 12">
                                        <ul class="left">
                                            <li class="waves-effect waves-light"><a href="?page=ask" class="judul"><i class="material-icons">print</i> Cetak Laporan WO Facility<a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
