...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submita'])) {
        ...
        $query = mysqli_query($config, "SELECT * FROM tbl_approve_cuti_normatif_kabag WHERE id_cuti_normatif='$id_cuti_normatif'");
        $no = 1;
        list($id_cuti_normatif) = mysqli_fetch_array($query);
        {
            ...
            $cek_data_qry = mysqli_query($config, "select * FROM tbl_approve_cuti_normatif_kabag where id_cuti_normatif='$id_cuti_normatif'");
            $cek_data = mysqli_num_rows($cek_data_qry);
            $cek_data_row = mysqli_fetch_array($cek_data_qry);
            if ($cek_data == 0) {
                $query = mysqli_query($config, "INSERT INTO tbl_approve_cuti_normatif_kabag(status_kabag,id_cuti_normatif,id_user)
                                        VALUES('$status_kabag','$id_cuti_normatif','$id_user')");
            } else {
                $query = mysqli_query($config, "UPDATE tbl_approve_cuti_normatif_kabag SET
                status_kabag='$status_kabag',
                id_cuti_normatif='$id_cuti_normatif',id_user='$id_user' WHERE id_kabag_normatif=$cek_data_row[id_kabag_normatif]");
            }
