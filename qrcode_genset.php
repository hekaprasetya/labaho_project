...
if ($form_qrcode_data) {
    ...
    $header = array("Nama Genset", "Tanggal", "Battery/ACCU", "Pendingin", "Bahan Bakar", "Panel", "Power House Genset");
    $isi_row = array("nama_genset", "tgl_genset", "c_accu", "c_pendingin", "c_bb", "c_panel", "c_phg");
...
WHERE a.id_utility='$id_utility'";
    ...
    if ($cek == 0) {
        ...
        header("Location: ./form_qrcode_genset.php");
        exit;
    }
    ...
    <body>
        <div class="row">
            <div class="disp">
                ...
                <h2 class="up">Master Utility GENSET</h2>
