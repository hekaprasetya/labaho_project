...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if ($_REQUEST['no_agenda'] == "" || $_REQUEST['divisi'] == "" || $_REQUEST['asal_surat'] == "" || $_REQUEST['isi'] == "" || $_REQUEST['kode'] == "" || $_REQUEST['indeks'] == "" || $_REQUEST['tgl_surat'] == "") {
                                    ...
                                    if (!preg_match("/^[0-9.-]*$/", $tgl_surat)) {
                                        ...
                                        if (!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)) {
                                            ...
                                            if ($file != "") {
                                                ...
                                                if (in_array($eks, $ekstensi) == true) {
                                                    if ($ukuran < 2300000) {
                                                        ...
                                                        if (!empty($file)) {
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE tbl_surat_masuk SET no_agenda='$no_agenda',divisi='$divisi',asal_surat='$asal_surat',isi='$isi',kode='$nkode',indeks='$indeks',tgl_surat='$tgl_surat',status='$status',file='$nfile',keterangan='$keterangan',id_user='$id_user' WHERE id_surat='$id_surat'");
                                                ...
                                                $query = mysqli_query($config, "UPDATE tbl_surat_masuk SET no_agenda='$no_agenda',divisi='$divisi',asal_surat='$asal_surat',isi='$isi',kode='$nkode',indeks='$indeks',tgl_surat='$tgl_surat',status='$status',keterangan='$keterangan',id_user='$id_user' WHERE id_surat='$id_surat'");
        ...
        $query = mysqli_query($config, "SELECT id_surat, no_agenda, divisi, asal_surat, isi, kode, indeks, tgl_surat,status, file, keterangan, id_user FROM tbl_surat_masuk WHERE id_surat='$id_surat'");
        list($id_surat, $no_agenda, $divisi, $asal_surat, $isi, $kode, $indeks, $tgl_surat, $status, $file, $keterangan, $id_user) = mysqli_fetch_array($query);
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">edit</i> View Data PMK</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                ...
                <form class="col s12" method="POST" action="?page=tsm&act=edit" enctype="multipart/form-data">
                    ...
                    <div class="row">
                     <div class="input-field col s6">
                            ...
                            <input id="no_agenda" type="text" class="validate" value="<?php echo $no_agenda ;?>" name="no_agenda">
                                <?php
                        ...
                        <div class="input-field col s6">
                            ...
                            <input type="text" class="form-control" id="kode" name="kode"  value="<?php echo $kode_jadi ?>">
                        ...
                        <div class="input-field col s6">
                         ...
                         <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">date_range</i>
                            <input id="keterangan" type="text" name="keterangan" class="datepicker" value="<?php echo $keterangan; ?>" required>
                            <?php
                            ...
                            ?>
                            <label for="keterangan">Tanggal Selesai Pekerjaan</label>
                        </div>
