    ...
    <body>
        ...
        <div id="colres">
            ...
            $query = mysqli_query($config, "SELECT a.*,
                                                 ...
                                                 WHERE id_cuti_normatif='$id_cuti_normatif'");
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    <table class="bordered" id="tbl">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td id="left" style="border-right: none;" width="20%">: <?= $row['no_form_normatif'] ?></td>
                                <td id="left" width="18%"><strong>Tgl.Dibuat </strong> : <?= indoDate($row['tgl']) ?></td>
                            </tr>
                            <tr>
                    ...
                    <table class="bordered" id="tbl">
                        ...
                        $query3 = mysqli_query($config, "SELECT a.*, 
                                                                ...
                                                                g.nama,
                                                                b.status_kabag, 
                                                                b.id_user as id_kabag_normatif,
                                                                h.nama as nama_kabag,
                                                                d.file_ttd as ttd_kabag,
                                                                c.status_hrd, 
                                                                c.id_user as id_hrd_normatif,
                                                                i.nama as nama_hrd,
                                                                e.file_ttd as ttd_hrd
                                                                
                                                        FROM tbl_cuti_normatif a
                                                        LEFT JOIN tbl_approve_cuti_normatif_kabag b ON a.id_cuti_normatif = b.id_cuti_normatif
                                                        LEFT JOIN tbl_user_upload  d ON b.id_user = d.id_user
                                                        LEFT JOIN tbl_approve_cuti_normatif_hrd c ON a.id_cuti_normatif = c.id_cuti_normatif
                                        ...
                                        <td><strong>
                                                <center>DIBUAT : <br><br>
                                                    ...
                                                    <td><strong>
                                                            ...
                                                            <center><?= $ttd_kabag ?><br><?= $row['status_kabag'] ?><br><?= $row['nama_kabag'] ?><br>
                                                                <center>
                                                                    </td>
                                                                    <td><strong>
                                                                            <center>DIKETAHUI :
                                                                        </strong>
                                                                    <center><?= $ttd_hrd ?><br><br><?= $row['status_hrd'] ?><br><?= $row['nama_hrd'] ?><br>
                                                                        </td>
                                                                        </tr>
                                                                        <?php
                                                                    }
