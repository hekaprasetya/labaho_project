...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        $query = mysqli_query($config, "INSERT INTO master_jabatan(jabatan) VALUES('$jabatan')");

        if ($query == true) {
            $_SESSION['succAdd'] = 'SUKSES! Data berhasil ditambahkan';
            $last_insert_id = mysqli_insert_id($config);
            echo '<script language="javascript">
                  window.location.href="./admin.php?page=master_jabatan";
                  </script>';
        } else {
            ...
            <div class="col s12">
                <nav class="secondary-nav">
                    <div class="nav-wrapper blue darken-2">
                        <ul class="left">
                            <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">bookmark</i> Tambah Jabatan</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
