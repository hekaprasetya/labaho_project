...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        $query = mysqli_query($config, "INSERT INTO master_satuan(satuan) VALUES('$satuan')");

        if ($query == true) {
            $_SESSION['succAdd'] = 'SUKSES! Data berhasil ditambahkan';
            $last_insert_id = mysqli_insert_id($config);
            echo '<script language="javascript">
                  window.location.href="./admin.php?page=master_satuan";
                  </script>';
        } else {
            ...
            <div class="col s12">
                <nav class="secondary-nav">
                    <div class="nav-wrapper blue-grey darken-1">
                        <ul class="left">
                            <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">bookmark</i> Tambah Satuan</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
            ...
            <form class="col s12" method="post" action="">
                ...
                <div class="input-field col s6">
                    ...
                    if (isset($_SESSION['satuan'])) {
                        ...
                        echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">' . $satuan . '</div>';
