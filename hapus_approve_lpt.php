<?php
    ...
    if(empty($_SESSION['admin'])){
    	...
    	$id_approve_lpt = mysqli_real_escape_string($config, $_REQUEST['id_approve_lpt']);

    	$query = mysqli_query($config, "SELECT * FROM tbl_approve_lpt WHERE id_approve_lpt='$id_approve_lpt'");
                            ...
                            <div class="card">
                                <div class="card-content">
            				        <table>
            				            ...
            				            <tbody>
            				                <tr>
            				                    <td width="13%">ttd_kabag</td>
            				                    <td width="1%">:</td>
            				                    <td width="86%">'.$row['ttd_kabag'].'</td>
            				                </tr>
