...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        $query = mysqli_query($config, "SELECT * FROM tbl_kabag_pp WHERE id_pp='$id_pp'");
        $no = 1;
        list($id_pp) = mysqli_fetch_array($query);
        {

            $id_pp = $_REQUEST['id_pp'];
            $status_kabag = $_POST['status_kabag'];
            $catatan_kabag = $_POST['catatan_kabag'];
            $id_user = $_SESSION['id_user'];
            $cek_data_qry = mysqli_query($config, "select * from tbl_kabag_pp where id_pp='$id_pp'");
            $cek_data = mysqli_num_rows($cek_data_qry);
            $cek_data_row = mysqli_fetch_array($cek_data_qry);
            if ($cek_data == 0) {
                $query = mysqli_query($config, "INSERT INTO tbl_kabag_pp(status_kabag,catatan_kabag,id_pp,id_user)
                                        VALUES('$status_kabag','$catatan_kabag','$id_pp','$id_user')");
                ...
                $query = mysqli_query($config, "UPDATE tbl_kabag_pp SET
                status_kabag='$status_kabag',
                catatan_kabag='$catatan_kabag',
                    id_pp='$id_pp',id_user='$id_user' WHERE id_kabag_pp=$cek_data_row[id_kabag_pp]");
            }
        ...
        <a class="btn small modal-trigger waves-effect waves-light tooltipped" data-position="right" data-tooltip="Klik Approve"  href="#modal<?= $id_pp ?>">APPROVE</i></a></span>
                ...
                <div class="row jarak-form">
                    <form class="col s12" method="post" action="">
                        <div class="input-field col s9">
                            ...
                            <select name="status_kabag" class="browser-default validate" id="status_kabag" required>
                        ...
                        <div class="input-field col s9">
                            ...
                            <textarea id="catatan_kabag" class="materialize-textarea validate" name="catatan_kabag"></textarea>
                            <label for="catatan_kabag">Catatan</label>
