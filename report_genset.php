...
?>
    ...
    <?php
    $judul = 'Genset';
    $table = 'utility_genset'; // nama table
    $pg_name = 'genset'; // nama halaman
    $id = 'id_genset'; //id table
    $tgl = 'tgl_genset'; // tanggal (timestamp)
    // array <thead></thead>
    $header1 = array("No.Form", "Pemeriksa", "Cek Accu", "Cek Pendingin", "Cek Panel");
    $header2 = array("waktu", "nama genset", "Cek cek pelumasan", "Cek bahan bakar", "Cek power house genset");
    // array <tbody></tbody>
    $isi_row1 = array("no_form", "nama", "c_accu", "c_pendingin", "c_panel");
    $isi_row2 = array("tgl_genset", "nama_genset", "c_pelumas", "c_bb", "c_phg");
                        ...
                        if (mysqli_num_rows($query) > 0) {
                            ...
                            while ($row = $query->fetch_assoc()) {  ?>
                                <tr>
                                    <td><?= $no ?></td>
                                    <?php
                                    foreach ($isi_row2 as $index => $kolom) {
                                        $head = $isi_row1[$index]; ?>
                                        <td><?= $row[$head]; ?><br>
                                            <hr>
                                            <?php if ($kolom == "$tgl") {
