                ...
                echo '
                    <div class="row jarak-form">
                        <ul class="collapsible white" data-collapsible="accordion">
                            <li>
                                <div class="collapsible-header white"><i class="material-icons md-prefix md-36">expand_more</i><span class="add">Tampilkan detail data E-PMK</span></div>
                                    <div class="collapsible-body white">
                                        <div class="col m12 white">
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td width="13%">No. Urut</td>
                                                        <td width="1%">:</td>
                                                    ...
                                                    <tr>
                                                        <td width="13%">Lokasi - Lantai - Ruang</td>
                                                        <td width="1%">:</td>
                                                        <td width="86%">'.$row['asal_surat'].'</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="13%">Ditujukan Kepada</td>
                                                        <td width="1%">:</td>
                                                    ...
                                                    <tr>
                                                        <td width="13%">Target Penyelesaian</td>
                                                        <td width="1%">:</td>
                                                        <td width="86%">'.indoDate($row['keterangan']).'</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
