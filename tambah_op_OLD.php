...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if ("") {
            ...
            $query = mysqli_query($config, "INSERT INTO tbl_op(no_op,tgl_op,tgl_brg_dtg,syarat_pembayaran,keterangan_op,id_user)
                                                                        VALUES('$no_op','$tgl_op','$tgl_brg_dtg','$syarat_pembayaran','$keterangan_op','$id_user')");
            ...
            if (isset($_SESSION["tableDet"])) {
                ...
                foreach ($tableDet as $i => $v) {
                    if ($tableDet[$i]["mode_item"] == "N") {
                        ...
                        mysqli_query($config, "INSERT INTO tbl_op_detail(nama_barang,jumlah_op,satuan,harga_op,keterangan_op_detail,total_op,total_ppn,nama_supplier,id_op)
                                                VALUES('$nama_barang','$jumlah_op','$satuan','$harga_op','$keterangan_op_detail','$total_op','$total_ppn','$nama_supplier','$id_op')");
                    }
                }
            }
                    ...
                    <table class="bordered" id="tbl">
                        ...
                        <tbody>
                            ...
                            if (isset($_SESSION["tableDet"])) {
                                ...
                                ?>
                               <tr>
                                    <td colspan="10" style="text-align: center"><strong><font color="red">*** JANGAN LUPA ISI DATA BARANG ***</font></strong></td>
                                </tr>
                                <?php
                            }
                            ?>
                                ...
                                <div class="row jarak-form">
                                    <form class="col s12" method="post" action="">
                                       <div class="input-field col s11">
                                            <i class="material-icons prefix md-prefix">build</i><label>Nama Barang</label><br/>
                                            <div class="input-field col s11 right">
                                                <select class="browser-default validate" name="nama_barang" id="nama_barang" required>
                                                    <?php
                                                    ...
                                                    while ($data = mysqli_fetch_array($hasil)) {
                                                        ...
                                                        ?>
                                                        <option
                                                            value="<?php echo $data['no_pp'];
                                                                         echo " / ";
                                                                         echo $data['status_gm'],$data['jumlah_gm'];
                                                                          echo " / ";
                                                                         echo $data['nama_barang']; ?>"><?php echo $data['no_pp'];
                                                                                                        echo " / ";
                                                                                                        echo $data['status_gm'],$data['jumlah_gm'];
                                                                                                        echo " / ";
        ...
        <div class="row">
            ...
            <div class="col 6">
                <a href="?page=op" class="btn small deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
            </div>
        </div>
