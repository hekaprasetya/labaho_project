...
?>
    ...
    <?php
    $judul = 'Panel';
    $table = 'utility_panel'; // nama table
    $pg_name = 'panel'; // nama halaman
    $id = 'id_panel'; //id table
    $tgl = 'tgl_panel'; // tanggal (timestamp)
    // array isi ari tabel
    $isi_row = array("no_form", "tgl_panel", "nama", "nama_panel", "item", "kondisi", "aktual", "keterangan_panel");
    $header = array("No.Form", "Tanggal", "Pemeriksa", "Nama Panel", "ITEM", "KONDISI", "AKTUAL", "KETERANGAN");
