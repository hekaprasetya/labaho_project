                                ...
                                <div class="col m7">
                                   <ul class="left">
                                        ...
                                        <li class="waves-effect waves-light">
                                            <a href="?page=pp&act=add"><i class="material-icons md-18">add_circle</i> Tambah</a>
                                        </li>
                ...
                if (isset($_REQUEST['submit'])) {
                   ...
                   $query = mysqli_query($config, "SELECT a.*,
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    ...
                                    <tr>
                                        <th>No</th>
                                        <th>No.PP<br/><hr/>Tgl.PP</th>
                                        <th>Target<br/><hr/>File</th>
                                        <th>Divisi<br/><hr/>Catatan</th>
                                        <th>Disetujui.Kabag<br/><hr/>Diketahui.Pembelian</th>
                                        <th>Diketahui Mng.Keuangan<br/><hr/>Disetujui.GM</th>
                                        <th>Diterima Gudang<br/><hr/>Waktu</th>
                                        <th>Pembuat</th>
                    ...
                    $query = mysqli_query($config, "SELECT a.*,
                                                           ...
                                                           ORDER by id_pp DESC LIMIT $curr, $limit");
                    if (mysqli_num_rows($query) > 0) {
                        $no = 0;
                        while ($row = mysqli_fetch_array($query)) {
                            $no++;
                            ...
                            //**KABAG APPROVE
                            if ($_SESSION['admin'] == 4 | $_SESSION['admin'] == 8 | $_SESSION['admin'] == 13 | $_SESSION['admin'] == 15 | $_SESSION['admin'] == 20) {
                                if (is_null($row['id_kabag_pp'])) {
                                    echo '<a class="btn small red waves-effect waves-light tooltipped" data-position="left" data-tooltip="Pilih untuk approval" href="?page=pp&act=app_kabag_pp&id_pp=' . $row['id_pp'] . '">
                                                <i class="material-icons">warning</i></a>';
                                } else {
