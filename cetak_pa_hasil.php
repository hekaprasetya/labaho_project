                        ...
                        <table class="bordered" id="tbl">
                            ...
                            <tr>
                               <?php
                                ...
                                $simpan_hasil = mysqli_query($config, "INSERT INTO tbl_pa_hasil(total_all,id_pa)
                                                              VALUES('$total_all','$id_pa')");
                                ?>
                                <!--td colspan="5"><span style="font-weight:bold"><center>TOTAL : <?php echo "Rp " . number_format("$pengeluaran[pengeluaran]", '0', '.', '.') ?> </center></span></td-->
                            <tr>
                            ...
                            <tr>
                                ...
                                <td id="left" style="border-right:" width="20%">: <strong><?php echo "Rp " . number_format("$ppn", '0', '.', '.') ?></strong></td>
