    				    ...
    				    <div class="col m12">
                            <div class="card">
                                ...
                                <div class="card-action">
            		                <a href="?page=usr&act=del&submit=yes&id_user='.$row['id_user'].'" class="btn small deep-orange waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
            		                <a href="?page=usr" class="btn small blue waves-effect waves-light white-text">BATAL <i class="material-icons">clear</i></a>
            		            </div>
                            </div>
                        </div>
                    </div>
