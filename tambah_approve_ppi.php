    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if( $_REQUEST['manager_tk'] == "" ){
                ...
                //validasi input data
                                if(!preg_match("/^[a-zA-Z0 ]*$/", $manager_tk)){
                                    $_SESSION['manager_tk'] = 'Form hanya boleh mengandung karakter huruf dan spasi';
                                    echo '<script language="javascript">window.history.back();</script>';
                                } else {
                                    
                                   

                                    $query = mysqli_query($config, "INSERT INTO tbl_approve_ppi(manager_tk, status,id_ppi,id_user)
                                        VALUES('$manager_tk','$status','$id_ppi','$id_user')");

                                    if($query == true){
                                        $_SESSION['succAdd'] = 'SUKSES! Data berhasil ditambahkan';
                                        echo '<script language="javascript">
                                                window.location.href="./admin.php?page=ppi&act=app_ppi";
                                              </script>';
                                    } else {
                    ...
                    <div class="row">
                     ...
                     <div class="input-field col s6">
                            ...
                            <div class="input-field col s11 right">
                                <select class="browser-default validate" name="manager_tk" id="manager_tk" required>
