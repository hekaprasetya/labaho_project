            ...
            if (!empty($file)) {
                ...
                if (in_array($eks, $ekstensi) == true) {
                    if ($ukuran < 10000000) {
                        ...
                        $query = mysqli_query($config, "INSERT INTO tbl_absen (longi, lati, status_absen, jenis_absen,file, id_user)
                        VALUES ('$longi', '$lati', '$status_absen', '$jenis_absen','$nfile','$id_user')");
            ...
            <div class="z-depth-1">
                <nav class="secondary-nav">
                    <div class="nav-wrapper blue darken-2">
                        <div class="col m7">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons md-3">add_alert</i> Tambah Absen Masuk</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
