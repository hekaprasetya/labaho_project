                            ...
                            if (strlen($username) < 5) {
                                ...
                                if (strlen($password) < 5) {
                                    ...
                                    if (mysqli_num_rows($query) > 0) {
                                        $do = mysqli_query($config, "UPDATE tbl_user SET password=MD5('$password') WHERE id_user='$id_user'");
        ...
        <div class="row">
            ...
            <div class="col s12">
                <nav class="secondary-nav">
                    <div class="nav-wrapper blue darken-2">
                        <ul class="left">
                            <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">person</i> Profil</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
