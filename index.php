    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col s12 m6 offset-m3 offset-m3">
                ...
                <!-- Box START -->
                <div class="card-panel z-depth-4" id="login">
                    ...
                    <div class="row">
                        ...
                        ?>
                            ...
                            <div class="col s12">
                                <div class="card-content">
                                    <h5 class="center" id="title">Labaho</h5>
                                    <?php echo '<img id="logo" src="upload/' . $data['logo'] . '">'; ?>
                                    <h4 class="center" id="smk">
                                        <h5 class="center" id="title">Labuan Bajo Holiday</h5>
                                    </h4>
                                    <div class="batas"></div>
                                </div>
                            </div>
                        ...
                        if (isset($_REQUEST['submit'])) {
                            ...
                            if ($_REQUEST['username'] == "" || $_REQUEST['password'] == "") {
                                ...
                                $query = mysqli_query($config, "SELECT id_user, username, nama, nip, admin, nama_tenant, divisi, file, email, tgl_lahir, tgl_join, tmpt_lahir, status, kontrak_habis, no_hp, kategori, jabatan, sisa_cuti FROM tbl_user WHERE username=BINARY'$username' AND password=MD5('$password')");

                                if (mysqli_num_rows($query) > 0) {
                                    list($id_user, $username, $nama, $nip, $admin, $nama_tenant, $divisi, $file, $email, $tgl_lahir, $tgl_join, $tmpt_lahir, $status, $kontrak_habis, $no_hp, $kategori, $jabatan, $sisa_cuti) = mysqli_fetch_array($query);
                                    ...
                                    $_SESSION['nama_tenant'] = $nama_tenant;
                                    $_SESSION['divisi'] = $divisi;
                                    $_SESSION['jabatan'] = $jabatan;
                                    $_SESSION['kategori'] = $kategori;
                                    $_SESSION['email'] = $email;
                                    $_SESSION['tgl_lahir'] = $tgl_lahir;
                                    $_SESSION['tmpt_lahir'] = $tmpt_lahir;
                                    $_SESSION['status'] = $status;
                                    $_SESSION['tgl_join'] = $tgl_join;
                                    $_SESSION['kontrak_habis'] = $kontrak_habis;
                                    $_SESSION['no_hp'] = $no_hp;
                                    $_SESSION['sisa_cuti'] = $sisa_cuti;
                                    $_SESSION['file'] = $file;
