            ...
            //validasi input data
                            if (!preg_match("/^[a-zA-Z0 ]*$/", $manager_mkt)) {
                                ...
                                echo '<script language="javascript">window.history.back();</script>';
                                    ...
                                    $query = mysqli_query($config, "UPDATE tbl_disposisi SET  manager_mkt='$manager_mkt',  id_surat='$id_surat', id_user='$id_user' WHERE id_disposisi='$id_disposisi'");
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                ...
                                <div class="input-field col s11 right">
                                    <select class="browser-default validate" name="manager_mkt" id="manager_mkt">
                                         <option value="<?php echo $row['manager_mkt']; ?>"><?php echo $row['manager_mkt']; ?></option>
